...
public class UIKitSettings {
    ...
    public static void setMapAccessKey(String mapsKey) {
...
//                Toast.makeText(context, "OnDisConnected", Toast.LENGTH_LONG).show();
    ...
    public static void publicGroup(boolean isEnable) {
        publicGroup = isEnable;
    }

    public static void passwordGroup(boolean isEnable) {
        passwordGroup = isEnable;
    }

    public static void privateGroup(boolean isEnable) {
        privateGroup = isEnable;
    }
    ...
    public static void sendGifs(boolean isEnable) {
        sendGifs = isEnable;
    }
    ...
    public static void unreadCount(boolean isEnable) {
        unreadCount = isEnable;
    }
