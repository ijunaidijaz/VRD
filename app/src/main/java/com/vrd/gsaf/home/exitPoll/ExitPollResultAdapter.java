...
public class ExitPollResultAdapter extends RecyclerView.Adapter<ViewHolderSurvey> {
    ...
    public ExitPollResultAdapter(List<Survey> pollList) {
    ...
    @Override
    public ViewHolderSurvey onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ViewHolderSurvey holder, int position) {
        try {
            if (!dataList.get(position).getSurveyType().equals("text")) {
                holder.questionTxt.setText(dataList.get(position).getSurveyQuestion());
                holder.questionTxt.setVisibility(View.VISIBLE);
                if (dataList.get(position).getSurveyGraphType().equals("pie") || dataList.get(position).getSurveyGraphType().equals("donut"))
                    pieGraph(holder, position);
                else if (dataList.get(position).getSurveyGraphType().equals("basicbar"))
    ...
    private void rating(ViewHolderSurvey holder, int position) {
        ...
        try {
            holder.ratingTxt1.setText(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(0).getTotalPercentage() + "%");
            holder.progress_1.setProgress(Float.floatToIntBits(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(0).getTotalPercentage()));

            holder.ratingTxt2.setText(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(1).getTotalPercentage() + "%");
            holder.progress_2.setProgress(Float.floatToIntBits(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(1).getTotalPercentage()));

            holder.ratingTxt3.setText(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(2).getTotalPercentage() + "%");
            holder.progress_3.setProgress(Float.floatToIntBits(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(2).getTotalPercentage()));

            holder.ratingTxt4.setText(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(3).getTotalPercentage() + "%");
            holder.progress_4.setProgress(Float.floatToIntBits(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(3).getTotalPercentage()));

            holder.ratingTxt5.setText(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(4).getTotalPercentage() + "%");
            holder.progress_5.setProgress(Float.floatToIntBits(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(4).getTotalPercentage()));
        } catch (Exception e) {
    ...
    private void pieGraph(ViewHolderSurvey holder, int position) {
        ...
        for (int i = 0; i < dataList.get(position).getSurveyResult().get(0).getOptionsResult().size(); i++) {
            // if (Float.compare(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getTotalPercentage(), 0) != 0) {
            barEntriesArrayList.add(new PieEntry(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getTotalPercentage()
                    , dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getOptionValue()));
            // labelNames.add(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getOptionValue());
            // }
        }
...
//        }
        ...
        barDataSet.setValueFormatter(new PercentFormatter(holder.pieChart));
    ...
    private void barGraph(ViewHolderSurvey holder, int position) {
        holder.pieChart.setVisibility(View.GONE);
        ...
        for (int i = 0; i < dataList.get(position).getSurveyResult().get(0).getOptionsResult().size(); i++) {
            ...
            barEntriesArrayList.add(new BarEntry(i, dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getTotalPercentage()));
            if (i != dataList.get(position).getSurveyResult().get(0).getOptionsResult().size() - 1)
                labelNames.add(dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getOptionValue());
            else {
                String l = dataList.get(position).getSurveyResult().get(0).getOptionsResult().get(i).getOptionValue();
...
class ViewHolderSurvey extends RecyclerView.ViewHolder {
    ...
    ViewHolderSurvey(View itemView) {
        super(itemView);
        mView = itemView;
